<template>
  <v-app>
    ...
    <v-footer app bottom color="primary lighten-1" padless>
...
export default {
  ...
  data: () => ({
    ...
    links: ["Home", "About Us", "Facebook", "LinkedIn"],
  }),
  mounted() {
  ...
  methods: {
    ...
    navToPage(link) {
      switch(link) {
        case "Home": return this.$router.push("/")
        case "About Us": return this.$router.push("/about")
        case "Facebook": return window.location.href = "https://www.facebook.com/UofT-Web-Project-Club-UTWPC-104336745307815"
        case "LinkedIn": return this.$router.push("#") // TODO: Need to replace a link here
      }
    }
  },
};
